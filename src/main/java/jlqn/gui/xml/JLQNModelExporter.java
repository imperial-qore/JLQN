...
public class JLQNModelExporter {
     ...
     */
    public JLQNModelExporter(JmtFileFilter defaultFilter, JmtFileFilter defaultSaveFilter) {
    ...
    protected int getXmlFileType(String fileName) {
        ...
        try {
            ...
            if (root.equals(JLQNModelExporter.XML_LQN_ROOT)) {
                return XML_LQN;
            } else {
                return FILE_UNKNOWN;
            }
