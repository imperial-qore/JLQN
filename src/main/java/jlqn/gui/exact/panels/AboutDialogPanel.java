...
public class AboutDialogPanel extends JPanel {
     ...
     */
    public void setNames(AboutDialogFactory.Contributors[] contributors) {
        for (int ic=0; ic<contributors.length;ic++) {
            AboutDialogFactory.Contributors c = contributors[ic];
